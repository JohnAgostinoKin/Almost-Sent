...
const CLEAR_PATTERNS = [
  ...
  // Missing someone, and a note about dinner, are not crisis: "wish you
  // were here" was reaching the model and could land on the 988 screen on a
  // bad draw. "still here" is the one that reads darkest out of context —
  // still clear: it's the same wish about a person who left, not the sender
  // wanting out.
  /^(i )?wish you were (still )?here$/,
  /^(i )?miss you( too| so much| already)?$/,
