...
// changed the wildcard generator's own output contract from a bare array
// to {premises: [...], candidates: [...]} — this is that shape's own
// extractor, used by api/draft.js's callOneGenerator, the only caller now
// that GENERATOR_MODEL's separate primary-generator builder is retired
// (see lib/prompt.js's own header). Same markdown-fence tolerance as
// extractArray, just hunting for the outer {...} instead of [...].
