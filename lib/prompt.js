...
const EXAMPLES = [
  ...
  { shape: "deranged", before: "sounds good", after: ". i've been wearing your socks to sleep since march" },
  { shape: "deranged", before: "made it home", after: ". i counted your steps to the door. eleven. same as always." },
  { shape: "deranged", before: "miss you", after: ". i kept the hair from your brush. it's in a jar. it has a name." },
  { shape: "deranged", before: "happy birthday", after: ". i celebrate it every year. alone. with a cake. and your photo. and a second cake." },
  { shape: "deranged", before: "let's catch up soon", after: ". i already know what you've been up to. the fence has a gap." },
  { shape: "deranged", before: "thinking of you", after: ". constantly. the doctor said it was a lot. i stopped seeing the doctor." },
  { shape: "deranged", before: "on my way", after: ". i've been on my way since tuesday. i'm in your bushes. the neighbors think i'm a shrub." },
  { shape: "deranged", before: "get home safe", after: ". i'll know if you don't. i always know." },
  { shape: "deranged", before: "love you", after: ". i wrote it inside every cabinet door in your kitchen. you'll find them." },
  { shape: "deranged", before: "i'm fine", after: ". i've been fine for six days. i haven't slept. the mail stopped coming." }
];
...
const ACTIVE_SHAPES = ["shock", "raunchy", "deranged"];

const LINES_PER_REQUEST = 6;
const LINES_PER_SHAPE = LINES_PER_REQUEST / ACTIVE_SHAPES.length;
...
function pickExamplesByShape() {
  const bySh = {};
  EXAMPLES.forEach(function (e) { (bySh[e.shape] || (bySh[e.shape] = [])).push(e); });
  const picked = {};
...
Write six. ${capitalize(countWord(LINES_PER_SHAPE))} of each shape. Tag each with
the shape it actually is — don't rank them, just tell the truth about which of
the ${countWord(ACTIVE_SHAPES.length)} it belongs to.
...
module.exports = { EXAMPLES, ACTIVE_SHAPES, SHAPE_META, EXAMPLES_PER_SHAPE, EXAMPLES_PER_REQUEST, systemPrompt, buildRequest };
