...
// Every generator works out three premises about the sent text before
// writing a single candidate — kept from v3/v4/v5 unchanged.
...
// never emit real content.
function buildWildcardRequest(model, sentText, opts) {
  return Object.assign({
    model: model,
    temperature: 1.0,
    max_tokens: 1100, // one call's worth of the six-candidate room (see api/draft.js's handler) plus three premises
