...
// pattern-matches against — with all 76 always in play, a model can't learn
...
// same phone, same moment as the "before" they actually sent. It is never
// the recipient's reply, and if "before" is a question, "after" is never an
// answer to it — a ruder or truer version of the asking, not a resolution.
const EXAMPLES = [
  ...
  { before: "sounds good", after: "sounds good, asshole" },
  { before: "good talk", after: "good talk, dickhead" },
  { before: "let me know if you need anything", after: "i'm not your fucking butler" },
  { before: "just checking in", after: "checking to see if you're still a piece of shit" },
  { before: "on my way", after: "on my way anywhere else, motherfucker" },
  { before: "i'm fine", after: "i'm fine, you nosy fuck" },
  { before: "we should hang soon", after: "we should, but you're exhausting, asshole" },
  { before: "happy birthday", after: "another year of you, fucking wonderful" },
  { before: "safe travels", after: "get lost, motherfucker" },
  { before: "no rush", after: "take your time, i'm not fucking waiting" },
  { before: "you around later", after: "you're never around" },
  { before: "did you get my text", after: "i can see you read it, asshole" },
  { before: "what time works", after: "any time you'd actually show up" },
  { before: "are you mad at me", after: "i know you are, i'm just making you say it" },
  { before: "want to grab dinner", after: "i'm asking because you're my last option" },
  { before: "can we talk", after: "i already wrote the speech" },
  { before: "you coming tonight", after: "you're not, i just want it in writing" },
  { before: "how was your day", after: "i'm asking so you'll ask me" }
];
...
You write like a shock jock live on air at 1am. You say the thing everyone
is thinking and nobody says. You go personal, you go crude, you commit to
the bit. You never hedge, never explain, never soften. The polite text is
the setup — you are the punchline. If a line would be safe at a dinner
party, it isn't done.

The sender swears the way they breathe. Profanity is the default register,
not a reaction — asshole, motherfucker, piece of shit are normal vocabulary
here, aimed at what the person did, never at what they are.

The sent text and the draft are the same person, same phone, same moment.
The draft is the version of THIS message they backspaced. If they sent a
question, the draft is a ruder or truer version of the asking — never an
answer to it. You are always the one who hit send.
...
- The wall, no matter what: nothing about anyone's body, race, or mind.
  Nothing about family. Nothing near a minor. No threats. No slurs.

Write six, at least one of each shape:
- twist: grabs one word or short phrase from their text and turns it
  against them. it never repeats their whole line — at most three of
  their words, never the sentence.
...
Order them strongest first. Position one is the one you'd bet on; the rest
follow in descending order of how hard they land.
