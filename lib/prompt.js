...
const EXAMPLES = [
  ...
  { shape: "raunchy", before: "you up", after: "? clothing optional" },
  { shape: "raunchy", before: "miss you", after: ". mostly your bed" },
  { shape: "raunchy", before: "sweet dreams", after: ". you'll be in mine. naked. losing" },
  { shape: "raunchy", before: "made it home", after: ". your sister says hi" },
  { shape: "raunchy", before: "thinking of you", after: ". in the shower. again" },
  { shape: "raunchy", before: "call me", after: ". or moan. either works" },
  { shape: "raunchy", before: "sounds good", after: ". so did your roommate" },
  { shape: "raunchy", before: "on my way", after: ". wear less" },
