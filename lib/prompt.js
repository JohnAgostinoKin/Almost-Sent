...
const EXAMPLES = [
  ...
  { before: "miss you", after: "did i leave the stove on" },
...
Write three. One punctures the polite line. One goes for the throat. One is a
non-sequitur: what the sender was actually thinking about while typing this —
an obscure TV reference, an errand, a stray grievance, something weirdly
specific and mundane. The joke is what it implies: their mind was elsewhere
and they're not that into this. Random isn't funny; distracted is. It has to
be something a real person would actually be thinking, not surreal for its
own sake.
