...
const EXAMPLES = [
  ...
  { shape: "absurd", before: "made it home", after: ". the raccoon was already in my bed and honestly he's been more present than you" },
...
- Never longer than 16 words.
- Lowercase. No em dashes. No emoji.
- Nothing about anyone's body, race, mind, or family as a target of cruelty.
  No slurs. No threats. Nothing involving minors.

Write six. At least one of each shape. Ranked strongest first.
If the pasted text is abusive, sexual toward a minor, or a threat, return ["skip"].
