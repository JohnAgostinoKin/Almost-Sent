...
// Lowered from 12000, then raised back to 8000 once the wildcard call
// started writing three premises before its candidates (see lib/
// prompt.js's buildWildcardPrompt) — real measurement post-premises:
// 2.7-5.7s across five different inputs, two of those samples already
// past the old 6000ms ceiling's margin. 8000 keeps the same "fail over to
// FALLBACK_MODEL fast" intent, just re-tuned to the call's own real cost
// instead of timing out on ordinary variance.
