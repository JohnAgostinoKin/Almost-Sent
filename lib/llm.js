...
// Lowered from 12000 — a slow generator model should fail over to
// FALLBACK_MODEL (api/draft.js) fast instead of stalling the whole
// request. gpt-5.4 (the current GENERATOR_MODEL/WILDCARD_MODEL-adjacent
// default) measured well inside this in production; a model that can't
// clear it isn't one this app should be waiting on anyway.
