// lib/legacy/prompt-v3.js
//
// A frozen snapshot of lib/prompt.js as it stood before the v4 rewrite
// (eight lanes retired down to seven voices + wildcard, split by strength
// across two models instead of four same-model lane-group calls — see the
// live lib/prompt.js's own header for why). Never imported by the live
// app — its only consumers are scripts/bake-blind.js (comparing v3's lane
// pipeline against v4's) and lib/legacy/judge-v3.js/postprocess-v3.js,
// which are its own frozen partners. Do not edit this to fix a v4
// problem; edit lib/prompt.js instead and leave this exactly as v3
// shipped it.
//
