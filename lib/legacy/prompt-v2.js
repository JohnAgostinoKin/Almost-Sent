// lib/legacy/prompt-v2.js
//
// A frozen snapshot of lib/prompt.js as it stood before the v3 lanes
// rewrite (four shapes: shock/raunchy/deranged/gross, one system prompt,
// pickBest-of-N lead + backfill alternates). Never imported by the live
// app — its only consumer is scripts/bake-blind.js's system A, which
// exists specifically to compare the old shape pipeline against v3's lane
// pipeline. Do not edit this to fix a v3 problem; edit lib/prompt.js
// instead and leave this exactly as v2 shipped it.
//
