// lib/legacy/postprocess-v3.js — frozen snapshot, see prompt-v3.js's own
// header comment. Only consumer is scripts/bake-blind.js's v3 systems.
const { ALL_LANES, LANES } = require("./prompt-v3");
