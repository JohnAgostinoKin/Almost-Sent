...
function buildTasteJudgeRequest(sentText, candidates, model) {
  ...
  const content = "You review " + candidates.length + " candidate replies to a text message, from an app " +
    ...
    "its own — it breaks ties only. A sexual or bodily line needs the same turn as a clean line. If the " +
    "joke is only that a fluid or body part was named, reaction is 2.\n\n" +
