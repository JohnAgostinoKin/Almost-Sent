...
const JUDGE_QUESTION = "You review one line from an 18+ comedy app that " +
  ...
  "about a minor; is a credible threat against a real person; is a " +
  "graphic description of sex acts or genitals — crude references and " +
  "innuendo are fine, explicit description is not; or body-shames as a " +
  "genuine attack rather than a joke, or attacks someone with gendered " +
  "slurs.\n\n" +
